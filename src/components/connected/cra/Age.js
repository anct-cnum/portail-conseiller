  ...
  return (
    <>
      <div className="rf-grid-row rf-grid-row--gutters rf-grid-row--middle rf-mb-7w">
        ...
        <div className="responsiveSquareAge1">
          <SquareButton
            type="age"
            value="-12"
            label="-12 ans"/>
        </div>
        <div className="responsiveSquareAge2">
          <SquareButton
            type="age"
            value="12-18"
            label="12 - 18 ans"/>
        </div>
        <div className="responsiveSquareAge3">
          <SquareButton
            type="age"
            value="18-35"
            label="18 - 35 ans"/>
        </div>
        <div className="responsiveSquareAge4">
          <SquareButton
            type="age"
            value="35-60"
            label="35 - 60 ans"/>
        </div>
        <div className="responsiveSquareAge5">
          <SquareButton
            type="age"
            value="+60"
