        ...
        <div className="fr-container">
          <div className="fr-grid-row">
            ...
            <div className="fr-col-9">
              <h2 className="fr-mb-6w titre2">Le contexte</h2>

              <h3 className="fr-mt-3w titre3">Octobre 2020&nbsp;: le lancement du dispositif et de sa plateforme de recrutement</h3>
              <p className="fr-mb-6w">L&rsquo;&eacute;tat initie le dispositif Conseiller num&eacute;rique France Services en octobre 2020, une
              ...
              <h3 className="fr-mt-3w titre3">Premier trimestre 2021&nbsp;: les fondements de l&rsquo;espace Coop</h3>
              <p className="fr-mb-6w">L&rsquo;&eacute;quipe de conception est agrandie &agrave; 7 personnes, dont 4 d&eacute;veloppeurs qui assurent
              ...
              <h3 className="fr-mt-3w titre3">Deuxi&egrave;me et troisi&egrave;me trimestres 2021&nbsp;: mises en ligne et davantage de services</h3>
              <p className="fr-mb-7w">L&rsquo;&eacute;quipe est progressivement agrandie &agrave; une dixaine de personnes, puis treize personnes en fin
              ...
              <h2 className="fr-mt-3w titre2">La philosophie de conception des outils&nbsp;: co-construire avec vous et en am&eacute;lioration continue </h2>
              <p className="fr-mb-5w">Les outils num&eacute;riques des conseillers sont conçus en mettant l&rsquo;humain avec la participation
              ...
              <h3 className="fr-mt-3w titre3">Quelques exemples concrets&nbsp;:</h3>
              <p className="fr-mb-7w">– Pour d&eacute;finir de mani&egrave;re pertinente ce que devait &ecirc;tre l&rsquo;espace Coop, un recueil a
              ...
              <h2 className="fr-mt-6w titre2">Vous aussi, vous pouvez contribuer si vous le souhaitez</h2>
              <p className="fr-mb-3w">Pour cela, rejoignez les canaux correspondants sur votre espace de discussion&nbsp;:</p>
            ...
            <div className="fr-col-offset-1 fr-col-2 fr-mt-12w">
