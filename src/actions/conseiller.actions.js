...
function getStatistiquesCSV(dateDebut, dateFin, codePostal, ville, codeCommune, idSubordonne, nomFichier) {
  return dispatch => {
    dispatch(request());
    conseillerService.getStatistiquesCSV(dateDebut, dateFin, codePostal, ville, codeCommune, idSubordonne)
    .then(
