...
const initialState = {
  ...
  geocodeAdresses: [],
  showLieuSecondaire: Array.from({ length: import.meta.env.VITE_APP_NOMBRE_LIEU_SECONDAIRE }, () => (false)),
  loadingHoraires: Array.from({ length: Number(import.meta.env.VITE_APP_NOMBRE_LIEU_SECONDAIRE) + 1 }, () => (false)),
  disabledFields: [],
  showSiret: [],
